...
namespace Proxies\__CG__\Joli\Bundle\BlogBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Category extends \Joli\Bundle\BlogBundle\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'posts', '' . "\0" . 'Joli\\Bundle\\BlogBundle\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'Joli\\Bundle\\BlogBundle\\Entity\\Category' . "\0" . 'name');
        }
